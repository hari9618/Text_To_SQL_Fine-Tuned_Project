...
| metric | **1** | **2** | **3** |
|---|---:|---:|---:|
| strict execution accuracy % <br><sub>higher is better</sub> | 10.82 | 9.27 | **50.99** |
| projection-tolerant % <br><sub>higher is better</sub> | 45.92 | 43.93 | **50.99** |
| executable SQL % <br><sub>higher is better</sub> | **98.90** | 92.27 | 95.81 |
| schema hallucination % <br><sub>lower is better</sub> | **0.66** | 3.31 | 1.99 |
| syntax error % <br><sub>lower is better</sub> | **0.00** | **0.00** | 0.22 |

## Strict execution accuracy by difficulty

| tier | n | **1** | **2** | **3** |
|---|---:|---:|---:|---:|
| easy | 126 | 0.0 | 0.0 | 23.0 |
| medium | 63 | 52.4 | 44.4 | 52.4 |
| hard | 144 | 3.5 | 2.1 | 84.7 |
| very_hard | 36 | 0.0 | 0.0 | 8.3 |
| enterprise | 84 | 13.1 | 13.1 | 52.4 |
